...
export default function Page({ params, searchParams }: { params: { locale: string }; searchParams?: { sent?: string } }) {
  ...
  if (locale === "ru") {
    items.push({
      title: <TitleWithIcon icon="/icons/pravo.png" className="h-12 sm:h-16 md:h-24 w-auto">Юридичні послуги та послуги Документ Сервіс для українців</TitleWithIcon>,
      content: (
        <p className="whitespace-pre-line" style={{ textAlign: "justify" }}>
