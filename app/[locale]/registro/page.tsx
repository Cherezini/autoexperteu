...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  const pathname = `/${locale}/registro`;

  const titles: Record<string, string> = {
    ru: "Регистрация автомобиля в Испании — ITV, IEDMT, DGT | AutoexpertEU",
    es: "Matriculación de coche en España — ITV, IEDMT, DGT | AutoexpertEU",
    en: "Car registration in Spain — ITV, IEDMT, DGT | AutoexpertEU",
  };
  const descriptions: Record<string, string> = {
    ru: "Постановка автомобиля на учёт в Испании под ключ: ITV, налог IEDMT, хестор и DGT — без бюрократии и рисков.",
    es: "Matriculación de vehículos con matrícula extranjera en España. ITV, impuesto IEDMT, gestoría y DGT — servicio llave en mano.",
    en: "Turnkey car registration in Spain for vehicles with foreign plates. ITV, IEDMT tax, gestor and DGT — without bureaucracy.",
  };
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ru: `${baseUrl}/ru/registro`,
        es: `${baseUrl}/es/registro`,
        en: `${baseUrl}/en/registro`,
        'x-default': `${baseUrl}/ru/registro`,
      },
    },
    openGraph: {
      title: titles[locale],
      ...
      type: "website",
      images: [{ url: `${baseUrl}/media/images/registro.jpg`, width: 1200, height: 630 }],
    },
  };
}
