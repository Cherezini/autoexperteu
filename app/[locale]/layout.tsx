...
export default function LocaleLayout({
  ...
  const navItems = [
    ...
    { name: L.germany, href: `/${locale}/avto-iz-germanii` },
    { name: L.registro, href: `/${locale}/registro` },
    { name: L.faq, href: `/${locale}/faq` }, // ИСПРАВЛЕНО: было /fao, стало /faq
      ...
      <div className="sticky top-0 w-full z-50 shadow-md" 
        ...
        <div className="container mx-auto px-4">
          <header className="flex items-center justify-between h-[80px] lg:h-[110px]">
            ...
            {/* ЯЗЫКИ (Десктоп) */}
            <div className="hidden lg:flex items-center gap-4 xl:gap-6 text-sm font-black mr-4 lg:mr-6 xl:mr-10" style={{ color: '#E6D3A1' }}>
              {['es', 'en', 'ru'].map((lang) => (
